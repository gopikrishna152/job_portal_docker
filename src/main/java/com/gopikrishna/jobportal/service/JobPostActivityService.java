...
import com.gopikrishna.jobportal.entity.JobCompany;
import com.gopikrishna.jobportal.entity.JobLocation;
import com.gopikrishna.jobportal.entity.JobPostActivity;
import com.gopikrishna.jobportal.entity.RecruiterJobsDto;
import com.gopikrishna.jobportal.repository.JobPostActivityRepository;
...
public class JobPostActivityService {
	...
	public List<RecruiterJobsDto> getRecruiterJobs(int recruiterId){
		...
		for(IRecruiterJobs rec:recruiterJobsDtos) {
			...
			JobCompany comp=new JobCompany(rec.getComapnyId(), rec.getName(), ""); 
