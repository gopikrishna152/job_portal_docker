package com.gopikrishna.jobportal.config;
...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler{
	...
	UserDetails userDetails=(UserDetails)	authentication.getPrincipal();
		...
		System.out.println("The username "+username+" logged in");
//		authentication.getAuthorities().stream().anyMatch(r->r.getAuthority().equals("Job Seeker"))
